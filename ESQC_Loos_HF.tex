...
\begin{frame}{The Fock matrix}
	...
	\begin{equation}
		...
		\qq{$\Rightarrow$}
		\boxed{\hf(\bx_1) \chi_i(\bx_1) = \underbrace{\epsilon_i}_{\alert{\text{orbital energy}}} \chi_i(\bx_1)}
	\end{equation}	
...
\begin{frame}{Canonical occupied orbitals are not unique}
	...
	\begin{itemize}
		...
		\item Mixing occupied and virtual orbitals changes the determinant
		\item Localization functional is generally nonconvex: different guesses may converge to different local extrema
	\end{itemize}
\end{frame}

%-----------------------------------------------------
\begin{frame}{Boys-Foster localization procedure}
	\begin{block}{Centroid and quadratic spread}
    	\begin{align}
    		\bR_i
    		&=
    		\mel{\psi_i}{\br}{\psi_i}
    	...
    	\end{align}
	\end{block}
	Boys-Foster localization minimizes the total spread
	\begin{equation}
		\boxed{
			\Omega_\text{BF}
			=
	...
	Because $\sum_i\mel{\psi_i}{r^2}{\psi_i}$ is invariant under occupied
