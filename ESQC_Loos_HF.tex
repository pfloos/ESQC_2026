...
\begin{frame}{An excited determinant is not an excited HF solution}
...
\begin{frame}{A spin-free Hamiltonian conserves $S$ and $M_S$}
	\begin{block}{Spin operators}
    	In the nonrelativistic, spin-free framework,
    	\begin{equation}
    		\boxed{
    			\comm{\chH}{\chS^2}=0
    			\qquad\text{and}\qquad
	...
	\begin{block}{Spin quantum numbers}
		\begin{itemize}
			...
			\item $M_S=-S,-S+1,\ldots,S$ is its spin projection
		\end{itemize}
	\end{block}
\end{frame}
