...
\begin{frame}{Localized orbitals}
	...
	\begin{tikzpicture}[x=1cm,y=1cm]
		...
		\draw[hfNavy,very thick,->] (-1.5,0.05)--(1.5,0.05)
			node[midway,above] {unitary transformation};
	...
	\begin{itemize}
		\item Only occupied-occupied or virtual-virtual rotations are invariant
		\item Mixing occupied and virtual orbitals changes the wavefunction and the energy
		\item Localization functionals are generally nonconvex: different guesses may converge to different local extrema
	\end{itemize}
\end{frame}
