...
%-----------------------------------------------------
\begin{frame}{Diagonalizing $\purple{\chS^2}$ produces pure singlet and triplet states}
...
\begin{frame}{Generalized Hartree-Fock}
	...
	\begin{equation}
		...
		\qq{with}
		\boldsymbol{\mathcal{C}} = \mqty(\bC^\alpha\\[0.2em]\bC^\beta)
		\qand
...
\begin{frame}{The GHF equations are Roothaan--Hall equations in spinor space}
	The overlap and orthogonalization matrices are duplicated in spin space,
	\begin{equation}
		...
		\begin{column}{0.48\textwidth}
			\begin{block}{Interpret with care}
				\begin{itemize}
					...
					\item GHF might be a rotated UHF
