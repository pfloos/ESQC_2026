...
\begin{frame}{Antisymmetry}
	...
	\begin{block}{Solution}
		...
		\begin{equation}
			\Psi(\red{\bx_1},\blue{\bx_2}) = \chi_1(\red{\bx_1}) \chi_2(\blue{\bx_2}) -  \chi_2(\red{\bx_1}) \chi_1(\blue{\bx_2})
		\end{equation}
		...
		\begin{equation}
			...
			\end{vmatrix}
			= \chi_1(\red{\bx_1}) \chi_2(\blue{\bx_2}) -  \chi_2(\red{\bx_1}) \chi_1(\blue{\bx_2})
			}
		\end{equation}
...
\begin{frame}{Spin contamination in UHF}
	...
	\begin{equation}
		\boxed{
			...
			=
			\underbrace{\expval{\purple{\chS^2}}_{\text{exact}}}_{M_S(M_S+1)}
			+
			N^\beta
			-
			\sum_{i=1}^{N^\alpha}
		...
		\begin{column}{0.4\textwidth}
        	...
        	\end{block}
         	\begin{block}{Two-electron part}
     		  	\begin{equation}
	        		G_{\mu\nu} = P_{\lambda\sigma} \mel{\mu\sigma}{}{\nu\lambda}
    	    	\end{equation}
        	\end{block}
		\end{column}
	\end{columns}
...
\begin{frame}{How to obtain a good guess for the MOs or density matrix?}
	\begin{block}{Possible initial density matrix}
		\begin{enumerate}
			...
			\bigskip
			\item Use \alert{extended H|"ckel theory or a semi-empirical method}:\\
...
\begin{frame}{How do I know I have converged (or not)?}
	...
	\begin{enumerate}
		...
		\item 	At self-consistency, the density and Fock matrices \alert{commute}:
    	\begin{equation}
    		\boxed{
    			\be^{(n)}
    			=
