...
%-----------------------------------------------------
\begin{frame}{The HF wavefunction}
...
%-----------------------------------------------------
\begin{frame}{Are excited determinants spin eigenfunctions?}
...
\begin{frame}{Spin and spatial symmetries}
	...
	\vfill
	\center
	$\Rightarrow$ \alert{The complete electronic wavefunction is antisymmetric in both cases}
\end{frame}
