...
\begin{frame}{Computing the electron repulsion integrals (ERIs)}
	...
	\end{columns}
			...
			\end{block}
	\begin{itemize}
		\item \textbf{\blue{Exponent:}} $\alpha$
		\item \textbf{\blue{Center:}} $\bA = (A_x, A_y, A_z)$
		\item \textbf{\blue{Angular momentum:}} $\ba = (a_x, a_y, a_z)$ and total angular momentum $a=a_x + a_y + a_z$
	\end{itemize}
	%
\end{frame}
...
\begin{frame}{Properties of Gaussian functions}
	\begin{block}{Gaussian product rule: \textit{``The product of two gaussians is a gaussian''}}
		...
		\end{equation}	
		\begin{equation}
		\boxed{G_{\red{\alpha},\red{\bA}}(\br) G_{\blue{\beta},\blue{\bB}}(\br) = \violet{K} \, G_{\violet{\zeta},\violet{\bP}}(\br)}
		\qqtext{with} 
