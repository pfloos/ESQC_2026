...
The practical UHF SCF algorithm is
\begin{enumerate}
...
The RHF wavefunction and energy are
\begin{equation}
...
The UHF orbitals can be parametrized as
\begin{equation}
  \boxed{
  \begin{aligned}
...
\paragraph{Generalized Hartree--Fock.}

The key idea is that GHF allows every orbital to choose its spin direction.
...
\input{ESQC_Loos_BF_chapter_content}
