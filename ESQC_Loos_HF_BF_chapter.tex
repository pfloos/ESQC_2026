...
\begin{equation}
  ...
  G_{\mu\nu}[\bP].
\end{equation}
The purpose of the following exercise is to make the contraction hidden in
$G_{\mu\nu}[\bP]$ explicit.
...
\paragraph{Energy in the AO representation.}
...
The books recommended in the slides are Jensen's \emph{Introduction to
