...
For open-shell systems, one uses \red{unrestricted spin orbitals},
\begin{equation}
  \chi_p^\text{UHF}(\bx)
  =\begin{cases}
    \alpha(\omega)\blue{\psi_p^\alpha(\br)},\\
...
To \red{minimize the UHF energy}, the unrestricted spatial orbitals must be
...
The unrestricted spatial orbitals are expanded in the same AO basis with
